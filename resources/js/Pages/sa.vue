        ...
        <div class="container-fluid">
          <div id="space">
            <div class="mb-8 p-2 w-full flex flex-wrap bg-grey-light">
              <div
                class="h-16 border-8 res w-full md:w-1/2 lg:w-1/3 bg-grey rows"
                v-for="(ss, ii) in data"
                :key="ii"
                ...
                >
                  ...
                  <div class="cc" v-if="item.action == 'D'">
                    ...
                    <label
                      ...
                      :style="{
                        background:
                          item.value == 1 ? item.option.color : 'gray',
                      }"
                    >
                      <div :class="item.value == 1 ? 'pr-7' : 'pl-10'">
                        {{ item.value == 1 ? "ON" : "OFF" }}
                      </div></label
                    >
                    <div class="daytimer">{{ afficheTimer(item.o) }}</div>
                  </div>
                  ...
                  <div class="cc" v-else-if="item.action == 'I'">
                    <div class="led-box">
                      <input
                        ...
                        false-value='"0"'
                      />
                      <label @click.prevent="" v-bind:for="'switch' + i + ii">
                        <div
                          class="led-green"
                          :style="{
                            background:
                    ...
                    >
                      <div
                        ...
                        :style="{
                          transform:
                            'rotate(' +
                            Analog(item.value, item.o) * 0.005 +
                            'turn)',
                      ...
                      >
                        <div
                          class="dm"
                          style="border-top: 5px black solid; width: 30%"
                        ></div>
                      </div>
                      <input
                        type="number"
                        v-bind:id="'switch' + i + ii"
                        :value="Analog(item.value, item.o)"
                  ...
                  <div class="cc" v-else>
                    <input
                      v-bind:id="'switch' + i + ii"
                      @change="switchChange($event, ii, i)"
                      :style="{ background: item.option.color }"
                      v-model="item.value"
                      class="
                        rounded-lg
                        ss
          ...
          <div class="modal-content py-4 text-left px-6">
            ...
            <div class="col-span-6 sm:col-span-3 my-5">
              ...
              <select
                ...
                "
              >
                <option v-for="(ss, ii) in options.pins"
                :key="ii" :value="ii" >{{ss}}</option>
              </select>
            </div>
...
//       console.log(result2);
  ...
  methods: {
    afficheTimer(o) {
      ...
      str += " at " + this.checkd(c[1]) + ":" + this.checkd(c[2]) + " => ";
      switch (parseInt(c[3])) {
        case 0:
          str += "Sunday";
          break;
    ...
    saveOptions() {
      ...
      if (!this.open) {
        ...
        else this.data[this.options.pos][this.options.index].o = this.options.o;
